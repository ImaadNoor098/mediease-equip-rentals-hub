  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-16">
        ...
        {/* CTA Section */}
        <section className="bg-medieaze-600 py-16">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-white mb-6">Need Healthcare Equipment?</h2>
            <p className="text-medieaze-100 text-lg max-w-2xl mx-auto mb-8">
              Whether you're looking to rent or buy, we have a wide range of quality medical equipment to meet your needs.
            </p>
            <button 
              onClick={() => navigate('/products')}
              className="bg-white text-medieaze-700 px-8 py-3 rounded-md font-medium hover:bg-medieaze-50 transition-colors"
            >
              Browse Our Products
            </button>
          </div>
